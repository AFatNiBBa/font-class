...
const Transporter_2: typeof Icon = x => (
    <Icon {...x}>
        ...
        <path d="M208 48a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm8 464l-88 0c-17.7 0-32-14.3-32-32s14.3-32 32-32l256 0c17.7 0 32 14.3 32 32s-14.3 32-32 32l-88 0-80 0zM351.3 164l48.1 60-286.7 0 48.1-60c18.2-22.7 45.8-36 74.9-36l40.7 0c29.1 0 56.7 13.2 74.9 36zM96 256.5l0-1c0 .3 0 .7 0 1z" />
    </Icon>
);
