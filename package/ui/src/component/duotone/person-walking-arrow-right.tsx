...
const PersonWalkingArrowRight: typeof Icon = x => (
    <Icon viewBox="0 0 640 512" {...x}>
        ...
        <path d="M505.4 153.4c12.5-12.5 32.8-12.5 45.3 0l80 80c12.5 12.5 12.5 32.8 0 45.3l-80 80c-12.5 12.5-32.8 12.5-45.3 0s-12.5-32.8 0-45.3L530.7 288 384 288c-17.7 0-32-14.3-32-32s14.3-32 32-32l146.7 0-25.4-25.4c-12.5-12.5-12.5-32.8 0-45.3z" />
    </Icon>
);
