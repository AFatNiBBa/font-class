...
const HandsHoldingHeart: typeof Icon = x => (
    <Icon viewBox="0 0 640 512" {...x}>
        ...
        <path d="M195.9 28.9c-29.4 29.8-29.4 78.2 0 108L297.5 240.1c6.2 6.3 14.3 9.4 22.5 9.4s16.3-3.1 22.5-9.4L444.1 136.9c29.4-29.8 29.4-78.2 0-108s-77-29.8-106.4 0L320 46.9l-17.7-18c-29.4-29.8-77-29.8-106.4 0z" />
    </Icon>
);
