...
const PlaneUpSlash: typeof Icon = x => (
    <Icon viewBox="0 0 640 512" {...x}>
        <path d="M256 93.7C256 59.5 285 0 320 0c36 0 64 59.5 64 93.7l0 66.3L576 288l0 96-91.2-30.4L620.9 459.3l19 14.7-29.4 37.9-19-14.7L19 52.7 0 38 29.4 .1l19 14.7L244.9 167.4 256 160l0-66.3zM448 449l0 63L320 480 192 512l0-64 64-48 0-80L64 384l0-96 97.3-64.9L384 398.5l0 1.5 38.4 28.8L448 449z" />
    </Icon>
);
