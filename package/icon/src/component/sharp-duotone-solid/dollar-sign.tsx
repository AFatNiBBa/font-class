...
const DollarSign: typeof Icon = x => (
    <Icon viewBox="0 0 320 512" {...x}>
        <path class={generic.secondary} d="M128 0l0 32 0 35.3c20.4-2.7 42.1-2.5 64 .3L192 32l0-32L128 0zm0 445.1l0 34.9 0 32 64 0 0-32 0-33.4c-10.2 1.2-20.7 1.6-31.4 1.3s-21.6-1.2-32.6-2.8z" />
