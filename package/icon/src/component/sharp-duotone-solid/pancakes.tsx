...
const Pancakes: typeof Icon = x => (
    <Icon {...x}>
        ...
        <path d="M480 96c0 35.3-100.3 64-224 64l0 64 0 32-64 0 0-32 0-66.7c-11-.9-21.7-2.1-32-3.5L160 272l0 32-64 0 0-32 0-131.2C56.4 129.2 32 113.4 32 96c0-35.3 100.3-64 224-64s224 28.7 224 64zM208 64l-16 0 0 32 16 0 96 0 16 0 0-32-16 0-96 0z" />
    </Icon>
);
