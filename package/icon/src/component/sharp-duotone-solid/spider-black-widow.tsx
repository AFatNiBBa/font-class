...
const SpiderBlackWidow: typeof Icon = x => (
    <Icon {...x}>
        <path class={generic.secondary} d="M67.7 133.6L79 145l72.1 72.1c8.3 2.8 16.6 5.5 24.9 8.3c0-17.1 0-34.2 0-51.3l-51.7-51.7 33.8-81.2 9.2-22.2L123.1 .6l-9.2 22.2-40 96-6.2 14.8zM216 288l0 16 24 32-24 32 0 16 80 0 0-16-24-32 24-32 0-16-80 0zM336 174.1l0 51.3 24.9-8.3L433 145l11.4-11.4-6.2-14.8-40-96L388.9 .6 344.6 19.1l9.2 22.2 33.8 81.2L336 174.1z" />
