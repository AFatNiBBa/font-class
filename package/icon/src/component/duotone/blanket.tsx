...
export default function Blanket(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 448 512" {...props}>
            <path opacity={.4} d="M448 128C448 128 447.908 261.697 447.723 301.26C446.24 258.441 411.172 224 368 224H128C57.422 224 0 281.422 0 352V128C0 75.125 43.125 32 96 32H352C404.875 32 448 75.125 448 128Z" />
