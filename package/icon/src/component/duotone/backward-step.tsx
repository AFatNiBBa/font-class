...
export default function BackwardStep(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 320 512" {...props}>
            <path opacity={.4} d="M31.998 64.031C14.326 64.031 0 78.357 0 96.031V415.967C0 433.641 14.328 447.967 32.002 447.967C49.674 447.967 64 433.641 64 415.969V256V96.033C64 78.359 49.672 64.031 31.998 64.031Z" />
