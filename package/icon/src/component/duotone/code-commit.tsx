...
export default function CodeCommit(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 640 512" {...props}>
            <path class={generic.secondary} d="M32 224C14.328 224 0 238.312 0 256S14.328 288 32 288H163.225C161.125 277.656 160 266.961 160 256S161.125 234.344 163.225 224H32ZM608 224H476.775C478.875 234.344 480 245.039 480 256S478.875 277.656 476.775 288H608C625.672 288 640 273.688 640 256S625.672 224 608 224Z" />
