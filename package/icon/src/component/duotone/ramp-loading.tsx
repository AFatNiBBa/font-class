...
export default function RampLoading(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 384 512" {...props}>
            <path class={generic.secondary} d="M384 32V352C384 369.75 369.75 384 352 384H320L288 320H320V64H64V320H96L64 384H32C14.25 384 0 369.75 0 352V32C0 14.25 14.25 0 32 0H352C369.75 0 384 14.25 384 32Z" />
