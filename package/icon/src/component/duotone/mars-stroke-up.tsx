...
export default function MarsStrokeUp(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 384 512" {...props}>
            <path class={generic.secondary} d="M256 335.999C256 371.345 227.346 399.999 192 399.999S128 371.345 128 335.999S156.654 272 192 272S256 300.653 256 335.999Z" />
