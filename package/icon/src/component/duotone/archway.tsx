...
export default function Archway(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 576 512" {...props}>
            <path opacity={.4} d="M560 448H544V64H32V448H16C7.125 448 0 455.125 0 464V496C0 504.875 7.125 512 16 512H176C184.875 512 192 504.875 192 496V320C192 267 235 224 288 224S384 267 384 320V496C384 504.875 391.125 512 400 512H560C568.875 512 576 504.875 576 496V464C576 455.125 568.875 448 560 448Z" />
