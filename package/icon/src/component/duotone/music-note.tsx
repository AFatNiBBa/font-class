...
export default function MusicNote(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 384 512" {...props}>
            <path opacity={.4} d="M256 148.088V17.547L311 1.322C320.625 -1.553 331.125 0.322 339.125 6.324C347.25 12.324 352 21.824 352 31.951V95.957C352 110.209 342.625 122.711 329 126.711L256 148.088Z" />
