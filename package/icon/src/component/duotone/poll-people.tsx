...
export default function PollPeople(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 640 512" {...props}>
            <path opacity={.4} d="M616 32H248C234.75 32 224 42.75 224 56V168C224 181.25 234.75 192 248 192H616C629.25 192 640 181.25 640 168V56C640 42.75 629.25 32 616 32ZM576 128H288V96H576V128ZM616 320H248C234.75 320 224 330.75 224 344V456C224 469.25 234.75 480 248 480H616C629.25 480 640 469.25 640 456V344C640 330.75 629.25 320 616 320ZM576 416H288V384H576V416Z" />
