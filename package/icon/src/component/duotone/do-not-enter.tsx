...
export default function DoNotEnter(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon {...props}>
            <path opacity={.4} d="M416.004 304H96.105C87.266 304 80 296.875 80 288V224C80 215.125 87.266 208 96.105 208H416.004C424.844 208 432.109 215.125 432.109 224V288C432.109 296.875 424.844 304 416.004 304Z" />
