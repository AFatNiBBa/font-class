...
export default function Tally_2(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 448 512" {...props}>
            <path opacity={.4} d="M32 32.001H32C14.327 32.001 0 46.327 0 64.001V448.001C0 465.674 14.327 480.001 32 480.001H32C49.673 480.001 64 465.674 64 448.001V64.001C64 46.327 49.673 32.001 32 32.001Z" />
