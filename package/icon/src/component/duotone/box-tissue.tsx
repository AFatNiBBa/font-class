...
export default function BoxTissue(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon {...props}>
            <path class={generic.secondary} d="M512 256V384H0V256C0 238.326 14.326 224 32 224H108.801L121.6 288H80C71.164 288 64 295.164 64 304S71.164 320 80 320H432C440.836 320 448 312.836 448 304S440.836 288 432 288H393.143L411.428 224H480C497.674 224 512 238.326 512 256Z" />
