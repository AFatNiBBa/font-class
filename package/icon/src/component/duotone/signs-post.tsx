...
export default function SignsPost(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon {...props}>
            <path opacity={.4} d="M224 496C224 504.836 231.164 512 240 512H272C280.838 512 288 504.836 288 496V352H224V496ZM272 0H240C231.164 0 224 7.164 224 16V32H288V16C288 7.164 280.838 0 272 0ZM224 224H288V160H224V224Z" />
