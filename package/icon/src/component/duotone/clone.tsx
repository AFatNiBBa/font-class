...
export default function Clone(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon {...props}>
            <path opacity={.4} d="M352 384V448C352 483.346 323.348 512 288 512H64C28.654 512 0 483.346 0 448V224C0 188.652 28.654 160 64 160H128V304C128 348.182 163.818 384 208 384H352Z" />
