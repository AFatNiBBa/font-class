...
export default function DisplayArrowDown(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 576 512" {...props}>
            <path opacity={.4} d="M576 48V368C576 394.5 554.5 416 528 416H48C21.5 416 0 394.5 0 368V48C0 21.5 21.5 0 48 0H264V64H64V352H512V64H312V0H528C554.5 0 576 21.5 576 48Z" />
