...
export default function $7(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 320 512" {...props}>
            <path opacity={.4} d="M314.125 103L122.125 455C113.438 470.969 96.969 480 79.969 480C72.187 480 64.312 478.125 57 474.125C33.75 461.437 25.156 432.281 37.875 409L191.156 128H48C21.5 128 0 106.5 0 80S21.5 32 48 32H272C288.938 32 304.625 40.938 313.281 55.5S322.25 88.125 314.125 103Z" />
        </Icon>
    </>
}