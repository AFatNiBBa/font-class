...
export default function Notdef(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 384 512" {...props}>
            <path class={generic.secondary} d="M64 390.312L153.541 256L64 121.688V64H102.459L192 198.312L281.541 64H320V121.688L230.459 256L320 390.312V448H281.541L192 313.688L102.459 448H64V390.312Z" />
