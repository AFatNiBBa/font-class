...
export default function SquareArrowUpRight(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 448 512" {...props}>
            <path opacity={.4} d="M384 32H64C28.654 32 0 60.656 0 96V416C0 451.344 28.654 480 64 480H384C419.346 480 448 451.344 448 416V96C448 60.656 419.346 32 384 32ZM344 312C344 329.688 329.688 344 312 344S280 329.688 280 312V245.25L158.625 366.625C152.375 372.875 144.188 376 136 376S119.625 372.875 113.375 366.625C100.875 354.125 100.875 333.875 113.375 321.375L234.75 200H168C150.312 200 136 185.688 136 168S150.312 136 168 136H312C329.688 136 344 150.312 344 168V312Z" />
