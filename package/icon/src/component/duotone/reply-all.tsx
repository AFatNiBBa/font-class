...
export default function ReplyAll(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 576 512" {...props}>
            <path opacity={.4} d="M8.387 226.158L184.387 378.158C199.762 391.455 224.074 380.705 224.074 360.002V344.168L66.406 208.002L224.074 71.834V56.018C224.074 35.346 199.793 24.549 184.387 37.846L8.387 189.846C-2.693 199.414 -2.693 216.59 8.387 226.158Z" />
