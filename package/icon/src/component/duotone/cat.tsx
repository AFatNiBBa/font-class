...
const Cat: typeof Icon = x => (
    <Icon viewBox="0 0 576 512" {...x}>
        <path class={generic.secondary} d="M171.8 261.9c13.5 6.8 27.1 13.5 40.6 20.3c.3 .1 .6 .3 .9 .4s.6 .2 .9 .3c.6 .1 1.2 .2 1.8 .2c4.2 0 8-3.3 8-8c0-19.1 0-38.2 0-57.4c-19.9 11.5-37.6 26.6-52.2 44.2zM241 209c12.2 12.2 24.3 24.3 36.5 36.5c4.5 4.5 12.2 2.2 13.5-4.1c3.2-16.1 6.5-32.3 9.7-48.4c-21.1 2.1-41.1 7.6-59.6 16z" />
