...
export default function SquareFragile(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 448 512" {...props}>
            <path opacity={.4} d="M384 32H64C28.654 32 0 60.652 0 96V416C0 451.346 28.654 480 64 480H384C419.346 480 448 451.346 448 416V96C448 60.652 419.346 32 384 32ZM320 208C320 255.539 285.363 294.734 240 302.387V384H288C296.836 384 304 391.162 304 400C304 408.836 296.836 416 288 416H160C151.164 416 144 408.836 144 400C144 391.162 151.164 384 160 384H208V302.387C162.637 294.734 128 255.539 128 208V112C128 103.162 135.164 96 144 96H304C312.836 96 320 103.162 320 112V208Z" />
