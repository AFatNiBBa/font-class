...
export default function DiagramSankey(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 640 512" {...props}>
            <path opacity={.4} d="M592 320H277L315 384H576C594 384 608 398 608 416V448C608 466 594 480 576 480H297C275 480 254 468 242 449L165 320H32C14 320 0 306 0 288V288C0 270 14 256 32 256H592C601 256 608 263 608 272V304C608 313 601 320 592 320Z" />
