...
const Mitten: typeof Icon = x => (
    <Icon viewBox="0 0 448 512" {...x}>
        <path class={generic.secondary} d="M352.014 384H64C46.398 384 32 398.4 32 416V480C32 497.6 46.398 512 64 512H352.014C369.613 512 384.014 497.6 384.014 480V416C384.014 398.4 369.613 384 352.014 384Z" />
