...
export default function SignalStrong(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 576 512" {...props}>
            <path opacity={.4} d="M544 0H544C526.327 0 512 14.327 512 32V480C512 497.673 526.327 512 544 512H544C561.673 512 576 497.673 576 480V32C576 14.327 561.673 0 544 0Z" />
