...
export default function BoothCurtain(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon {...props}>
            <path opacity={.4} d="M0 32V496C0 504.75 7.25 512 16 512H48C56.75 512 64 504.75 64 496V64H160V0H32C14.25 0 0 14.25 0 32ZM480 0H448V496C448 504.75 455.25 512 464 512H496C504.75 512 512 504.75 512 496V32C512 14.25 497.75 0 480 0Z" />
