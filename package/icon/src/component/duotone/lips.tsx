...
export default function Lips(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 576 512" {...props}>
            <path opacity={.4} d="M0.395 224H63.838C63.838 224 138.597 320 288.005 320S512.171 224 512.171 224H575.605C576.698 233.531 575.56 243.289 571.716 252.398C546.496 312.25 470.275 448 324.702 448H251.298C105.725 448 29.504 312.25 4.284 252.398C0.44 243.289 -0.698 233.531 0.395 224Z" />
