...
export default function ChairOffice(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 448 512" {...props}>
            <path opacity={.4} d="M256 451.375V384H192V451.375C163.75 457.375 141 471 130.125 488.625C123.75 498.875 132.5 512 145.125 512H302.875C315.5 512 324.25 498.875 317.875 488.625C307 471 284.25 457.375 256 451.375ZM288 0H160C124.625 0 96 28.625 96 64V288H352V64C352 28.625 323.375 0 288 0Z" />
