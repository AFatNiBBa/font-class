...
export default function BriefcaseClock(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 640 512" {...props}>
            <path opacity={.4} d="M496 224C416.375 224 352 288.375 352 368S416.375 512 496 512S640 447.625 640 368S575.625 224 496 224ZM544 384H489.75C484.375 384 480 379.625 480 374.25V304C480 295.162 487.164 288 496 288C504.838 288 512 295.162 512 304V352H544C552.838 352 560 359.162 560 368C560 376.836 552.838 384 544 384ZM320.975 352H208C199.156 352 192 344.844 192 336V288H0V432C0 457.594 22.406 480 48 480H360.234C335.102 449.568 320 410.549 320 368C320 362.582 320.488 357.289 320.975 352Z" />
