...
export default function TruckPickup(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 640 512" {...props}>
            <path opacity={.4} d="M176 304C127.398 304 88 343.398 88 392C88 440.6 127.398 480 176 480S264 440.6 264 392C264 343.398 224.602 304 176 304ZM464 304C415.398 304 376 343.398 376 392C376 440.6 415.398 480 464 480S552 440.6 552 392C552 343.398 512.602 304 464 304Z" />
