...
export default function DownRight(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 384 512" {...props}>
            <path opacity={.4} d="M25.373 134.626L70.629 89.372C83.125 76.876 103.385 76.876 115.883 89.372L245.492 218.984L154.984 309.496L25.373 179.884C12.875 167.384 12.877 147.126 25.373 134.626Z" />
