...
export default function Bed(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 640 512" {...props}>
            <path class={generic.secondary} d="M176 128C131.875 128 96 163.875 96 208S131.875 288 176 288S256 252.125 256 208S220.125 128 176 128ZM544 128H304C295.163 128 288 135.163 288 144V320H640V224C640 170.981 597.019 128 544 128Z" />
