...
export default function AlignJustify(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 448 512" {...props}>
            <path opacity={.4} d="M416 288H32C14.327 288 0 302.327 0 320V320C0 337.673 14.327 352 32 352H416C433.673 352 448 337.673 448 320V320C448 302.327 433.673 288 416 288ZM416 32H32C14.327 32 0 46.327 0 64V64C0 81.673 14.327 96 32 96H416C433.673 96 448 81.673 448 64V64C448 46.327 433.673 32 416 32Z" />
