...
export default function Staff(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon {...props}>
            <path opacity={.4} d="M96 303.982V348.104L156.121 287.982H111.998C103.125 287.982 96 295.107 96 303.982ZM369.857 284.732L402.105 303.357C409.73 307.855 419.605 305.23 423.98 297.607L443.479 263.734L369.857 284.732Z" />
