...
export default function DropletDegree(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 448 512" {...props}>
            <path opacity={.4} d="M368 32C323.937 32 288 67.938 288 112S323.937 192 368 192S447.999 156.062 447.999 112S412.062 32 368 32ZM368 144C350.25 144 336 129.75 336 112S350.25 80 368 80C385.75 80 400 94.25 400 112S385.75 144 368 144Z" />
