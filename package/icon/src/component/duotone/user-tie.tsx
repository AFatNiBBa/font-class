...
export default function UserTie(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 448 512" {...props}>
            <path opacity={.4} d="M176 288L208 344L176.012 479.953L184 512H264L271.988 479.953L240 344L272 288H176ZM224 0C153.25 0 96 57.25 96 128S153.25 256 224 256S352 198.75 352 128S294.75 0 224 0Z" />
