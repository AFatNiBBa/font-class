...
export default function HeartHalf(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon {...props}>
            <path opacity={.4} d="M256 96.241L275.68 75.924C325.629 24.358 408.684 15.885 462.959 62.862C525.104 116.653 528.197 212.516 472.176 270.485L279.025 470.197C272.695 476.744 264.346 480.005 256 479.994V96.241Z" />
