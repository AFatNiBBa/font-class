...
export default function RupiahSign(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon {...props}>
            <path opacity={.4} d="M392 160H328C305.908 160 288 177.908 288 200V472C288 494.092 305.908 512 328 512S368 494.092 368 472V400H388.549C445.807 400 497.916 361.309 509.414 305.217C525.221 228.094 466.416 160 392 160ZM392 320H368V240H392C414.062 240 432 257.938 432 280S414.062 320 392 320Z" />
