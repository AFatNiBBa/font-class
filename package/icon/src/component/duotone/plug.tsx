...
export default function Plug(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 384 512" {...props}>
            <path opacity={.4} d="M96 0C78.375 0 64 14.375 64 32V160H128V32C128 14.375 113.625 0 96 0ZM288 0C270.375 0 256 14.375 256 32V160H320V32C320 14.375 305.625 0 288 0Z" />
