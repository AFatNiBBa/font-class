...
export default function ValueAbsolute(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon {...props}>
            <path opacity={.4} d="M40 32C17.908 32 0 49.908 0 72V440C0 462.092 17.908 480 40 480S80 462.092 80 440V72C80 49.908 62.092 32 40 32ZM472 32C449.908 32 432 49.908 432 72V440C432 462.092 449.908 480 472 480S512 462.092 512 440V72C512 49.908 494.092 32 472 32Z" />
