...
const Ribbon: typeof Icon = x => (
    <Icon viewBox="0 0 448 512" {...x}>
        <path class={generic.secondary} d="M225.021 379.297L110.683 504.131C102.683 512.881 89.181 514.631 79.306 507.881L10.55 480.006C-1.452 471.883 -3.577 455.133 6.05 444.258L145.82 291.449L225.021 379.297Z" />
