...
export default function CalendarWeek(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 448 512" {...props}>
            <path opacity={.4} d="M0 192V464C0 490.5 21.5 512 48 512H400C426.5 512 448 490.5 448 464V192H0ZM384 336C384 344.75 376.75 352 368 352H80C71.25 352 64 344.75 64 336V272C64 263.25 71.25 256 80 256H368C376.75 256 384 263.25 384 272V336Z" />
