...
export default function SterlingSign(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 320 512" {...props}>
            <path opacity={.4} d="M224 224H128V288H224C241.688 288 256 273.672 256 256S241.688 224 224 224ZM0 256C0 273.672 14.312 288 32 288H48V224H32C14.312 224 0 238.328 0 256Z" />
