...
export default function CurlingStone(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 576 512" {...props}>
            <path opacity={.4} d="M0 384C0 437.02 42.98 480 96 480H480C533.02 480 576 437.02 576 384V368H0V384ZM480 224H96C42.98 224 0 266.98 0 320V336H576V320C576 266.98 533.02 224 480 224Z" />
