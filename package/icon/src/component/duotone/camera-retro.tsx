...
export default function CameraRetro(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon {...props}>
            <path opacity={.4} d="M464 32H271.107C261.172 32 251.373 34.312 242.486 38.756L192 64H48C21.49 64 0 85.49 0 112V160H512V80C512 53.49 490.51 32 464 32ZM256 224C211.908 224 176 259.908 176 304C176 348.09 211.908 384 256 384S336 348.09 336 304C336 259.908 300.092 224 256 224Z" />
