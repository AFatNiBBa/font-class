...
const EarListen: typeof Icon = x => (
    <Icon {...x}>
        <path class={generic.secondary} d="M64 480A32 32 0 1 1 0 480a32 32 0 1 1 64 0zM41.4 361.4c12.5-12.5 32.8-12.5 45.3 0l64 64c12.5 12.5 12.5 32.8 0 45.3s-32.8 12.5-45.3 0l-64-64c-12.5-12.5-12.5-32.8 0-45.3zM192 352a32 32 0 1 1 -64 0 32 32 0 1 1 64 0zM355.4 17.7c7.9-15.8 27.1-22.2 43.1-14.2c.3 .1 .4 .2 .6 .3c.3 .2 .7 .4 1.2 .7c1 .5 2.3 1.3 4 2.2c3.3 1.9 7.7 4.7 13 8.3c10.5 7.3 24.4 18.3 38.3 33.3C483.5 78.6 512 126 512 192c0 17.7-14.3 32-32 32s-32-14.3-32-32c0-46-19.5-78.6-39.5-100.3c-10.1-10.9-20.2-19-27.7-24.2c-3.7-2.6-6.8-4.5-8.7-5.6c-1-.6-1.7-1-2.1-1.2l-.4-.2c-15.7-7.9-22-27.1-14.2-42.9zM384 32c4.8-9.5 9.5-19.1 14.5-28.6c-.1-.1-.1-.1-14.5 28.6z" />
