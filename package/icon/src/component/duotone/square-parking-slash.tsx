...
export default function SquareParkingSlash(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 640 512" {...props}>
            <path opacity={.4} d="M288 352C288 369.6 273.6 384 256 384H256C238.4 384 224 369.6 224 352V272.234L96 171.91V416C96 451.346 124.654 480 160 480H480C480.972 477.185 480.962 477.214 481.933 474.399L288 322.396V352ZM480 32H160C138.375 32 119.461 42.836 107.949 59.289L225.709 151.588C229.492 138.133 241.379 128 256 128H336C395.166 128 442.125 181.998 430.113 243.23C426.412 262.096 416.574 278.15 403.398 290.857L544 401.059V96C544 60.654 515.348 32 480 32ZM368 224C368 206.375 353.625 192 336 192H288V200.408L352.344 250.84C361.527 245.205 368 235.527 368 224Z" />
