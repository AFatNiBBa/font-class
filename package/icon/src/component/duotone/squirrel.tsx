...
export default function Squirrel(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon {...props}>
            <path opacity={.4} d="M287.992 288.076L216.041 504.346C149.117 484.785 97.082 426.711 96.02 354.676C95.645 329.221 101.756 305.523 112.027 284.158C47.939 269.578 0 212.504 0 144C0 64.471 64.469 0 143.996 0S287.992 64.471 287.992 144V288.076Z" />
