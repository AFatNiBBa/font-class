...
export default function BitcoinSign(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 320 512" {...props}>
            <path opacity={.4} d="M80 0C62.312 0 48 14.312 48 32V64H112V32C112 14.312 97.688 0 80 0ZM48 480C48 497.688 62.312 512 80 512S112 497.688 112 480V448H48V480ZM176 0C158.312 0 144 14.312 144 32V64H172C184.645 64 196.598 66.539 208 70.295V32C208 14.312 193.688 0 176 0ZM144 448V480C144 497.688 158.312 512 176 512S208 497.688 208 480V447.596C206.641 447.643 205.369 448 204 448H144Z" />
