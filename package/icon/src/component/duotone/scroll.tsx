...
export default function Scroll(props: ComponentProps<typeof Icon>) {
    return <>
        <Icon viewBox="0 0 576 512" {...props}>
            <path class={generic.secondary} d="M480 128V352H288V400C288 444.184 252.184 480 208 480C163.818 480 128 444.184 128 400V96C128 60.654 99.348 32 64 32H384C437 32 480 75 480 128Z" />
